...
public abstract class DrivetrainRotateAbsolutePIDCommand extends DrivetrainRelativeRotateCommand {
    ...
    public DrivetrainRotateAbsolutePIDCommand(double targetAngle) {

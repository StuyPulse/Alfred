...
public interface RobotMap {
    ...
    double DRIVETRAIN_WHEEL_DIAMETER = 6;
    double DRIVETRAIN_WHEEL_INCHES_PER_REVOLUTION = DRIVETRAIN_WHEEL_DIAMETER * Math.PI;
    double DRIVETRAIN_EMPIRICAL_RAW_MULTIPLIER = 1;
    double DRIVETRAIN_GEAR_RATIO = 60/24;
    double DRIVETRAIN_ENCODER_RAW_MULTIPLIER = DRIVETRAIN_GEAR_RATIO * DRIVETRAIN_WHEEL_INCHES_PER_REVOLUTION * DRIVETRAIN_EMPIRICAL_RAW_MULTIPLIER;
